...
import requests  # 如果没有这个库，需要在终端运行 pip install requests
import re
...
import os  # 确保代码顶部有导入 os 模块，用于读取文件

# https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=44ba0a2e-4510-4804-9d3c-f2c53f39e267
...
def run_agent_task(query_days=7):
    ...
    send_wecom_message(summary, final_results)
